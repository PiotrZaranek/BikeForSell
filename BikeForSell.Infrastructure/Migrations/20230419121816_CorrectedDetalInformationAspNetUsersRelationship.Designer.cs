...
namespace BikeForSell.Infrastructure.Migrations
{
    ...
    [Migration("20230419121816_CorrectedDetalInformationAspNetUsersRelationship")]
    partial class CorrectedDetalInformationAspNetUsersRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeForSell.Domain.Models.BikeDetailInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BikeForSell.Domain.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BikeForSell.Domain.Models.BikeDetailInformation", b =>
                {
                    b.HasOne("BikeForSell.Domain.Models.Bike", "Bike")
                        ...
                        .HasForeignKey("BikeForSell.Domain.Models.BikeDetailInformation", "BikeRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BikeForSell.Domain.Models.ApplicationUser", "User")
                        .WithMany("DetailInformation")
            ...
            modelBuilder.Entity("BikeForSell.Domain.Models.Transaction", b =>
                {
                    b.HasOne("BikeForSell.Domain.Models.Bike", "Bike")
                        .WithOne("Transaction")
                        .HasForeignKey("BikeForSell.Domain.Models.Transaction", "BikeRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BikeForSell.Domain.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
